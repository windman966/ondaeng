...
class GeofenceErrorMessages {
    ...
    public static String getErrorString(Context context, Exception e) {
        if (e instanceof ApiException) {
            ...
            return "Unknown error: the Geofence sevice is not available now";
        }
    }
    ...
    public static String getErrorString(Context context, int errorCode) {
        ...
        switch (errorCode) {
            case GeofenceStatusCodes.GEOFENCE_NOT_AVAILABLE:
                return "Geofecne Service is not available now";
            case GeofenceStatusCodes.GEOFENCE_TOO_MANY_GEOFENCES:
                return "Your app has registered too many geofences";
            case GeofenceStatusCodes.GEOFENCE_TOO_MANY_PENDING_INTENTS:
                return "You have provided  too many PendingIntents to the addGeofence";
            default:
